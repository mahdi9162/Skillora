...
import UserNotFoundAnimation from '../assets/search empty.json';
...
const MyProfile = () => {
  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center px-4 md:px-0 py-24">
        <div className="w-60 md:w-72">
          <Lottie animationData={UserNotFoundAnimation} loop={true} />
        </div>
        <h2 className="mt-6 text-xl md:text-2xl font-semibold text-slate-800">User not found</h2>
        <p className="mt-2 text-sm text-center md:text-left md:text-base text-slate-500">
          Your session may have expired. Please log in again to view your profile.
        </p>
        <Link
          to="/login"
          className="mt-6 px-6 py-2.5 rounded-full bg-primary text-white text-sm font-semibold shadow-md hover:shadow-lg transition-all"
        >
          Go to Login
        </Link>
      </div>
  ...
  return (
    <>
      ...
      >
        {/* My Profile */}
        <Container>
          <section className="mt-10 mb-6 mx-3 lg:mx-0" data-aos="fade-up-left">
        ...
        <Container>
          <section
            className="my-10 py-8 px-5 md:px-10 lg:px-20 mx-3 lg:mx-0 rounded-4xl bg-linear-to-br from-[#E0F7FF]/60 via-white to-[#F8FBFD] shadow-[0_10px_40px_rgba(14,165,233,0.08)] border border-white/60 backdrop-blur-sm"
        ...
        <Container>
          <section
            className="flex flex-col md:flex-row justify-between items-center gap-6 my-12 py-8 px-6 md:px-10 lg:px-20 rounded-4xl bg-linear-to-br from-[#E0F7FF]/50 via-white to-[#F8FBFD] shadow-[0_12px_35px_rgba(14,165,233,0.08)] border border-white/60 backdrop-blur-sm"
            data-aos="fade-up"
          >
            {/* Title */}
